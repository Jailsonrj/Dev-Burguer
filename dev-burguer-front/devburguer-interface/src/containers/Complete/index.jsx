...
import "../../components/Stripe/CheckoutForms/styles.css";
...
const STATUS_CONTENT_MAP = {
  ...
  processing: {
    text: "Seu pagamento está sendo processado.",
    iconColor: "#6D6E78",
    icon: InfoIcon,
  },
...
export function CompletePayment() {
  ...
  return (
    <div className="container">
      ...
      <h2 id="status-text" style={{color: STATUS_CONTENT_MAP[status].iconColor, textAlign: 'center'}}>{STATUS_CONTENT_MAP[status].text}</h2>
      ...
      {intentId && <a href={`https://dashboard.stripe.com/payments/${intentId}`} id="view-details" rel="noopener noreferrer" target="_blank">Ver detalhes do pagamento
